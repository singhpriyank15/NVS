...
------------------- Transaction present for same SFIDs b/w ODS-Veeva: Update Rec_modify_date in ODS & delete upd_data_id in VEEVA --------------------------
...
spark.sql("insert into all_all_r_all_bkp.ods_contacts_addr_case1_1 select * from ALL_ALL_B_USA_CRMODS.ods_contacts_addr")
